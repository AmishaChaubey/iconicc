...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16 md:h-auto">
          ...
          <div className="hidden lg:block">
            <button
              ...
              className="group relative flex items-center gap-2 px-6 py-3 rounded-lg overflow-hidden transition-all duration-500"
              style={{
      ...
      {/* Mobile Navigation Overlay - Using Portal-like approach */}
      {mobileOpen && (
        <div 
        ...
        >
          ...
          {/* Mobile Menu Content */}
          <div className="relative z-10 h-screen w-full flex flex-col justify-center items-center px-4 pt-20 pb-8">
            
            {/* Mobile Navigation Links */}
            <div className="flex flex-col gap-6 sm:gap-8 text-center mb-12 w-full animate-fadeIn">
              {navLinks.map((link, index) => (
                <a
                  key={link.label}
                  href={link.href}
                  onClick={closeMobileMenu}
                  className="text-2xl sm:text-3xl md:text-4xl font-black text-white hover:text-[#D0AB69] transition-colors duration-300"
                  style={{
                    fontFamily: '"Playfair Display", serif',
                    animation: `slideUp 0.5s ease-out ${index * 80 + 100}ms both`
                  }}
                >
                  {link.label}
                </a>
            ...
            <button
              ...
              style={{
                ...
                animation: `slideUp 0.5s ease-out 500ms both`
              }}
